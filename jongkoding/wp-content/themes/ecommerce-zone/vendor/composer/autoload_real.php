...
class Ecommerce_Zone_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function ecommerce_zone_loadClassLoader($class)
    {
    ...
    public static function ecommerce_zone_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
