...
function signify_customize_preview_js() {
	...
	wp_enqueue_script( 'signify-customize-preview', trailingslashit( esc_url ( get_template_directory_uri() ) ) . $path . 'customize-preview' . $min . '.js', array( 'customize-preview' ), '20180103', true );
}
